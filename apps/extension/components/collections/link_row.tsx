...
import { ContextMenu, MenuItem, Modal, ConfirmModal } from '@minimalstuff/ui';
...
export function LinkRow({ link, collectionId }: Readonly<LinkRowProps>) {
	...
	return (
		<ContextMenu
			items={
				<>
					<MenuItem icon="i-octicon-copy-16" onClick={handleCopyLink}>
						Copy link
					</MenuItem>
					<MenuItem icon="i-octicon-pencil" onClick={handleEdit}>
						Edit
					</MenuItem>
					<MenuItem icon="i-ion-trash-outline" onClick={handleDelete} danger>
						Delete
					</MenuItem>
				</>
			}
